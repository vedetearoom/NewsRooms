        ...
        return (
          ...
          >
            <div className="w-full flex items-start justify-between">
              <div className="w-11 h-11 rounded-xl flex items-center justify-center shrink-0 bg-zinc-900 text-white dark:bg-zinc-100 dark:text-zinc-900 font-bold text-lg shadow-[inset_0_0_0_1px_rgba(255,255,255,0.1)] dark:shadow-[inset_0_0_0_1px_rgba(0,0,0,0.1)]">
